...
const partsMod: ModuleDef = {
  ...
  submodules: [
    {
      slug: "part-collection", hidden: true,
    ...
    {
      slug: "part-inventory", hidden: true,
    ...
    {
      slug: "part-return-status", hidden: true,
    ...
    {
      slug: "return-pickup", hidden: true,
      title: "Return & Pickup",

...
export interface SubModuleDef {
  ...
  count?: number;
  hidden?: boolean;  // if true, not shown as a card on module landing page
  custom?: "part-return-status" | "claims-pipeline" | "work-map" | "part-order" | "part-receive" | "ticket-list" | "user-management" | "account-management" | "location-management" | "part-return" | "po-status" | "part-inventory" | "part-history" | "bulk-order" | "frequently-parts-used" | "inventory-adjust-history" | "invoice-list" | "lot-management" | "part-alert-report" | "part-daily-collection" | "part-daily-pickup" | "part-footprint-custom" | "part-inventory-detail-custom" | "part-lot-scan" | "part-management-custom" | "part-research-custom" | "part-return-summary-custom" | "part-triage-custom" | "reserved-part-list-custom" | "return-pickup-custom" | "tech-part-inout-report" | "a-part-alert-management-custom" | "a-parts-by-model-management-custom" | "a-physical-part-inventory-custom" | "a-triage-management-custom" | "hr-daily-report" | "parts-dashboard" | "csr-dashboard" | "claims-dashboard" | "csr-daily-report" | "call-tracker" | "csr-status-summary" | "claims-daily-report" | "triage-daily-report" | "parts-daily-report" | "operations-daily-report" | "eastern-tx-daily-report" | "western-tx-daily-report" | "central-tx-daily-report" | "repair-statuses" | "encompass-claim-audit"; // hook for special pages
}
...
const dashboardMod: ModuleDef = {
  ...
  submodules: [
    ...
    {
      slug: "repair-forecast", hidden: true,
    ...
    {
      slug: "pto-leave-management", hidden: true,
    ...
    { slug: "parts-dashboard", title: "Parts Dashboard", description: "Parts operations overview — PO queue, collections, receives and distributor breakdown.", fields: [], seed: ()=>({}), custom: "parts-dashboard" as any },
    { slug: "csr-dashboard", title: "CSR Dashboard", description: "CSR team performance overview, statuses and activity.", fields: [], seed: ()=>({}), custom: "csr-dashboard" as any },
    { slug: "claims-dashboard", title: "Claims Dashboard", description: "Claims operations overview — completion trend, brand mix, pre-auth aging, and staff performance.", fields: [], seed: ()=>({}), custom: "claims-dashboard" as any },
    { slug: "csr-daily-report", title: "CSR Daily Report", description: "CSR agent performance — tasks, schedule, attempts, mistakes.", fields: [], seed: ()=>({}), custom: "csr-daily-report" as any, hidden: true },
    { slug: "call-tracker", title: "Call Tracker", description: "Tickets handled and calls made per agent per day.", fields: [], seed: ()=>({}), custom: "call-tracker" as any, hidden: true },
    { slug: "csr-status-summary", title: "CSR Status Summary", description: "Summary of all ticket statuses handled by CSR agents.", fields: [], seed: ()=>({}), custom: "csr-status-summary" as any, hidden: true }
],
};
  ...
  submodules: [
    {
      ...
      fields: [],
      seed: () => ({}),
      custom: "part-daily-collection" as any,
    },
    {
      slug: "part-footprint",
      ...
      fields: [],
      seed: () => ({}),
      custom: "part-footprint-custom" as any,
    },
    {
      slug: "part-history",
    ...
    },
    {
      ...
      fields: [],
      seed: () => ({}),
      custom: "part-management-custom" as any,
    },
    {
      slug: "part-order",
      title: "Part Order",
    ...
    },
    {
      ...
      fields: [],
      seed: () => ({}),
      custom: "part-daily-pickup" as any,
    },
    {
      slug: "part-receive",
      title: "Part Receive",
    ...
    },
    {
      slug: "bulk-order",
      title: "Bulk Order",
      description: "Place bulk part orders across multiple tickets.",
      fields: [],
      seed: () => ({}),
      custom: "bulk-order" as any,
    },
    {
      slug: "frequently-parts-used",
      title: "Frequently Parts Used",
      description: "Most frequently ordered and used parts.",
      fields: [],
      seed: () => ({}),
      custom: "frequently-parts-used" as any,
    },
    {
      slug: "inventory-adjust-history",
      title: "Inventory Adjust History",
      description: "History of all inventory adjustments.",
      fields: [],
      seed: () => ({}),
      custom: "inventory-adjust-history" as any,
    },
    {
      slug: "invoice-list",
      title: "Invoice List",
      description: "Invoice list for parts and services (new).",
      fields: [],
      seed: () => ({}),
      custom: "invoice-list" as any,
    },
    {
      slug: "lot-management",
      title: "Lot Management",
      description: "Manage part lots and batch tracking.",
      fields: [],
      seed: () => ({}),
      custom: "lot-management" as any,
    },
    {
      slug: "part-alert-report",
      title: "Part Alert Report",
      description: "Alerts for parts needing attention.",
      fields: [],
      seed: () => ({}),
      custom: "part-alert-report" as any,
    },
    {
      slug: "part-inventory-detail",
      title: "Part Inventory Detail",
      description: "Detailed inventory breakdown per part.",
      fields: [],
      seed: () => ({}),
      custom: "part-inventory-detail-custom" as any,
    },
    {
      slug: "part-lot-scan",
      title: "Part Lot Scan",
      description: "Scan and track part lots.",
      fields: [],
      seed: () => ({}),
      custom: "part-lot-scan" as any,
    },
    {
      slug: "part-research",
      title: "Part Research",
      description: "Research part availability, pricing, and compatibility.",
      fields: [],
      seed: () => ({}),
      custom: "part-research-custom" as any,
    },
    {
      slug: "part-return-summary",
      title: "Part Return Summary",
      description: "Summary of all part returns by vendor and period.",
      fields: [],
      seed: () => ({}),
      custom: "part-return-summary-custom" as any,
    },
    {
      slug: "part-triage",
      title: "Part Triage",
      description: "Triage and prioritize parts needing action.",
      fields: [],
      seed: () => ({}),
      custom: "part-triage-custom" as any,
    },
    {
      ...
      fields: [],
      seed: () => ({}),
      custom: "reserved-part-list-custom" as any,
    },
    {
      slug: "tech-part-inout-report",
      title: "Tech Part In/Out Report",
      description: "Parts issued to and returned by technicians.",
      fields: [],
      seed: () => ({}),
      custom: "tech-part-inout-report" as any,
    },
    {
      slug: "a-part-alert-management",
      title: "(A) Part Alert Management",
      description: "Admin management of part alerts and thresholds.",
      fields: [],
      seed: () => ({}),
      custom: "a-part-alert-management-custom" as any,
    },
    {
      slug: "a-parts-by-model-management",
      title: "(A) Parts-by-Model Management",
      description: "Admin: manage part-to-model associations.",
      fields: [],
      seed: () => ({}),
      custom: "a-parts-by-model-management-custom" as any,
    },
    {
      slug: "a-physical-part-inventory",
      title: "(A) Physical Part Inventory",
      description: "Admin: physical inventory count and reconciliation.",
      fields: [],
      seed: () => ({}),
      custom: "a-physical-part-inventory-custom" as any,
    },
    {
      slug: "a-triage-management",
      title: "(A) Triage Management",
      description: "Admin: manage triage rules and assignments.",
      fields: [],
      seed: () => ({}),
      custom: "a-triage-management-custom" as any,
    }
  ],
};
...
const claimsMod: ModuleDef = {
  ...
  submodules: [
    ...
    },
    {
      ...
      custom: "encompass-claim-audit" as any,
      fields: [
        { key: "claimNo", label: "Claim No", filterable: true },
        { key: "location", label: "Location", type: "select", options: CLAIM_LOCATIONS, filterable: true },
    ...
    },
    {
      ...
      custom: "monthly-part-report" as any,
      fields: [
        { key: "month", label: "Month", filterable: true },
        { key: "location", label: "Location", type: "select", options: CLAIM_LOCATIONS, filterable: true },
    ...
    },
    {
      ...
      custom: "unclaimed-parts-report" as any,
      fields: [
        { key: "ticketNo", label: "Ticket No", filterable: true },
        { key: "location", label: "Location", type: "select", options: CLAIM_LOCATIONS, filterable: true },
        { key: "partNo", label: "Part No", filterable: true },
    ...
    },
    {
      ...
      custom: "repair-code-restriction" as any,
      fields: [
        { key: "claimCompany", label: "Claim Company", type: "select", options: CLAIM_COMPANIES, filterable: true },
    ...
    },
    {
      ...
      custom: "sales-summary-report" as any,
      fields: [
        { key: "location", label: "Location", type: "select", options: CLAIM_LOCATIONS, filterable: true },
        { key: "month", label: "Month", filterable: true },
    ...
    },
    {
      ...
      custom: "tech-payroll-setup" as any,
      fields: [
        { key: "tech", label: "Technician", type: "select", options: TECHS, filterable: true },
        { key: "location", label: "Location", type: "select", options: CLAIM_LOCATIONS, filterable: true },
    ...
    },
    {
      ...
      custom: "repair-status-report" as any,
...
const reportMod: ModuleDef = {
  slug: "report",
  label: "Report",
  tagline: "Daily operational reports across all departments",
  accent: "#34d399",
  submodules: [
    { slug: "hr-daily-report", title: "HR Daily Report", description: "Interview, hiring, warnings and terminations per branch.", fields: [], seed: ()=>({}), custom: "hr-daily-report" as any },
    { slug: "claims-daily-report", title: "Claims Daily Report", description: "Claims completed vs remaining, brand breakdown and pending types.", fields: [], seed: ()=>({}), custom: "claims-daily-report" as any },
    { slug: "triage-daily-report", title: "Triage Daily Report", description: "Triage completed, remaining, staff and agent performance.", fields: [], seed: ()=>({}), custom: "triage-daily-report" as any },
    { slug: "parts-daily-report", title: "Part Daily Report", description: "Parts staff performance — collections, RA, receives per branch.", fields: [], seed: ()=>({}), custom: "parts-daily-report" as any },
    { slug: "operations-daily-report", title: "Operations Daily Report", description: "Operations staff tasks, mishandled tickets and pending details.", fields: [], seed: ()=>({}), custom: "operations-daily-report" as any },
    { slug: "eastern-tx-daily-report", title: "Eastern TX Daily Report", description: "Technician LTP, completion rates and branch metrics — Eastern region.", fields: [], seed: ()=>({}), custom: "eastern-tx-daily-report" as any },
    { slug: "western-tx-daily-report", title: "Western TX Daily Report", description: "Technician LTP, completion rates and branch metrics — Western region.", fields: [], seed: ()=>({}), custom: "western-tx-daily-report" as any },
    { slug: "central-tx-daily-report", title: "Central TX Daily Report", description: "Technician LTP, completion rates and branch metrics — Central region.", fields: [], seed: ()=>({}), custom: "central-tx-daily-report" as any }
  ],
};

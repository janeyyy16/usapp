...
export const ACTIVITY_ACTION_LABELS: Record<string, string> = {
  ...
  master_w2_office_agreement_sent: "Sent Master W-2 Office Agreement",
  master_w2_office_agreement_signed: "Signed Master W-2 Office Agreement",
  master_w2_office_agreement_employer_signed: "Completed Master W-2 Office Agreement (employer signature)",
  master_ph_contractor_agreement_sent: "Sent Master PH Contractor Agreement",
  master_ph_contractor_agreement_signed: "Signed Master PH Contractor Agreement",
  master_ph_contractor_agreement_employer_signed: "Completed Master PH Contractor Agreement (employer signature)",
  master_w2_executive_agreement_sent: "Sent W-2 Executive Exempt Management Agreement",
  master_w2_executive_agreement_signed: "Signed W-2 Executive Exempt Management Agreement",
  master_w2_executive_agreement_employer_signed: "Completed W-2 Executive Exempt Management Agreement (employer signature)",

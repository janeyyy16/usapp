/** Country name + E.164 calling code, for the Phone field's "Country Code" picker (see phoneElement in formElements/basic.tsx). Several countries share a code (e.g. US/Canada are both +1) — that's expected, the dropdown lists every country by name but the field only ever stores the dial code itself. */

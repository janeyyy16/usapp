/**
 * External Fill Personal Vehicle Mileage and Fuel Policy Agreement — the
 * no-login counterpart to FillMileageFuelPage.tsx, opened from the link
 ...
 *
 * Same real-PDF overlay rendering as FillMileageFuelPage.tsx (identical
 * field rects). The PDF is built entirely client-side via the same pure
 * fillMileageFuelPdf used by the logged-in flow, then POSTed
...
export function ExternalFillMileageFuelPage({ docId }: Props) {

...
export function NeedClaimList({ mod, sub }: Props) {
  ...
  const handleExportCSV = () => {
    exportToCSV("need_claim_list",
      ["Location","Ticket No","Wty Type","Status","Technician","Product","Comp/Cancel","Repair Type","Parts","Mile","Claim To","Pre-Claim Status","TAT","Paid by Cx"],
      filtered.map((r:any)=>[r.location,r.ticketNo,r.wtyType,r.status,r.tech,r.product,r.compCancel,r.repairType,r.parts,r.mile,r.claimTo,r.preClaimStatus,r.tat,r.paidByCx])
    );
  };

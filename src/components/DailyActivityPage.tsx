...
// existing component-to-component consumers (e.g. Triage Daily Report's
// own Activity panel), which is a same-chunk import and stays fine as-is.
import { classify, BUCKET_LABEL, BUCKET_COLOR, BUCKET_ORDER, type ActionBucket } from "@/lib/ticketActivityBuckets";
export { classify, BUCKET_LABEL, BUCKET_COLOR, BUCKET_ORDER, type ActionBucket };

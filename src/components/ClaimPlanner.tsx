...
export function ClaimPlanner({ mod, sub }: Props) {
  ...
  // top of whatever came next in normal flow (the date picker, then the
  // table) instead of cleanly above it. Same pattern as ClaimList.tsx /
  // ClaimCalendarWeekly.tsx.

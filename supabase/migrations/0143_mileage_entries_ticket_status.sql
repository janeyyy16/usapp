-- =====================================================================
-- 0143 — Ticket status on mileage entries
--
-- Denormalized snapshot of the originating ticket's status at sync time —
-- same convention as ticket_no (migration 0142) and technician_name
-- (migration 0134). Now that syncing pulls every assigned ticket rather
...
--
-- Backfills every already-synced row too, same reasoning as 0142's

-- =====================================================================
-- 0162 — Staff List's per-branch roster becomes a live view of the same
-- profiles Master List already manages, instead of its own frozen copy
-- imported from Excel.
--
-- staff_list_roster (0161) never actually held data (every earlier
...
--
-- Run once in the Supabase SQL Editor, after 0161. Follow with

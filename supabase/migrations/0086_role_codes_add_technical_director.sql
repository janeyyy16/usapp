-- =====================================================================
-- 0086_role_codes_add_technical_director.sql
--
-- Expand the role check on profiles.role so the new Technical Director
-- role the UI can now select is actually storable.
--
-- Rewrites the constraint from 0024 verbatim, appending the new code.
--

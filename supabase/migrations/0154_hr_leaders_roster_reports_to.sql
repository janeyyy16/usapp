-- =====================================================================
-- 0154 — Leaders tab: reporting hierarchy within a department
--
...
-- Technician rows by 0153, to reconstruct which Senior Branch Manager each
-- Branch/Tech Manager actually reports to.
--
-- Run once in the Supabase SQL Editor, after 0153.
-- =====================================================================

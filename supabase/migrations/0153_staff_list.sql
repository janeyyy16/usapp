-- =====================================================================
-- 0153 — Dashboard "Staff List" submodule.
--
...
-- in the source file, 28 imported — see 0154's header comment for the 2
-- skipped), a branch-manager summary ("Current Staff" sheet), and a pay
-- rate table by tech tier ("Tier Level" sheet).
--
-- Same company-scoped RLS/trigger pattern as hr_leaders_roster (0145).
-- row_sort preserves each sheet's original row order.
--
-- Run once in the Supabase SQL Editor, after 0152. Real data import is a
